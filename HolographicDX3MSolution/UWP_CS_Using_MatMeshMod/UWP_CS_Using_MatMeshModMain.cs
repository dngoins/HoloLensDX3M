...
using UWP_CS_Using_MatMeshMod.Common;
...
using UWP_CS_Using_MatMeshMod.Content;
#endif

namespace UWP_CS_Using_MatMeshMod
{
    /// <summary>
    /// Updates, renders, and presents holographic content using Direct3D.
    /// </summary>
    internal class UWP_CS_Using_MatMeshModMain : IDisposable
    {
        ...
        public UWP_CS_Using_MatMeshModMain(DeviceResources deviceResources)
        {
